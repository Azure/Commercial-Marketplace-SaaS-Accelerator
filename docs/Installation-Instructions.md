...
| MeteredSchedulerSupport | Enable the metered scheduler. This is deployed by default. Pass NO to disable the feature. More information [here](https://github.com/Azure/Commercial-Marketplace-SaaS-Accelerator/blob/main/docs/Metered-Scheduler-Manager-Instruction.md).
