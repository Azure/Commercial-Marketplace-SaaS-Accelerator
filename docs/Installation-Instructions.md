...
* Create another Web App for the marketplace provisioning service, using the same process you used for the original Web App.
...
* Click the button to start the deployment of SQL database
