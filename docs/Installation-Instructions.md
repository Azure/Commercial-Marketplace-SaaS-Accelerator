...
You can install the SaaS Accelerator code using a __single command__ line within the **Azure Portal**. If you prefer to run the script **locally**, please refer to instruction can be found [here](Advanced-Instructions.md)
