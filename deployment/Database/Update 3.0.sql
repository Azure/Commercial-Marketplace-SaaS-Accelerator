...
Update EmailTemplate set TemplateBody = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">               
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <!--<note>Use this Template for Pending Activation email </note>-->                                                    
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                              <tr>
                                 <td valign="top" class="bodyContent">
                                    ...
                                    #if($arminputparms.Count > 0)                                      <b>Input Parameters</b></br>                                                                              
                                    <table border="1" cellpadding="0" cellspacing="0" width="50%">
                                       #foreach( $prod in $arminputparms )                                                                                              
                                       <tr>
                                    ...
                                    #end                                      #if($armoutputparms.Count > 0)                                      <b>Output Parameters</b></br>                                                                            
                                    <table border="1" cellpadding="0" cellspacing="0" width="50%" >
                                       #foreach( $prod in $armoutputparms )                                                                                              
                                       <tr>
                                          <td><b>$prod.Parameter</b></td>
