...
| RejectSubscriptionUpdates | If True, reject customer update requests from Azure portal on the Webhook. If False or the key doesnt exist, Subscirption updates are accepted.  |
