...
az webapp create -g $ResourceGroupForDeployment -p $WebAppNameService -n $WebAppNameAdmin  --runtime DOTNETCORE:8.0 --output $azCliOutput
...
Write-host "      ➡️ Create Web App"
az webapp create -g $ResourceGroupForDeployment -p $WebAppNameService -n $WebAppNamePortal --runtime DOTNETCORE:8.0 --output $azCliOutput
Write-host "      ➡️ Assign Identity"
