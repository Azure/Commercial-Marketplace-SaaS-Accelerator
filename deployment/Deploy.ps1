...
Param(  
   ...
   [string][Parameter()]$ADApplicationIDAdmin, # Multi-Tenant Active Directory Application ID for the Admin Portal
...
$ISLoginAppProvided = ($ADApplicationIDAdmin && $ADMTApplicationIDPortal)
