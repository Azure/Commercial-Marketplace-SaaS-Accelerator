...
Invoke-Sqlcmd -query $compatibilityScript -ServerInstance tcp:botsa-saas-sql.database.windows.net -database $Database -Username CloudSA3fd2f8f3 -Password 4lq7%PyOhFz59hzh
