    ...
    public class WebRequestHelper
    {
        ...
        {   
            if ((string.Equals(HttpMethods.GET.ToString(), method) || string.Equals(HttpMethods.DELETE.ToString(), method)) && parameters != null && parameters.Count() > 0)
            {
                ...
                this.URL = string.Format("{0}?{1}", this.URL, this.payload);
            }
        ...
        {
            if (string.Equals(HttpMethods.POST.ToString(), this.method) || string.Equals(HttpMethods.PUT.ToString(), method) || string.Equals(HttpMethods.PATCH.ToString(), this.method))
            {
        ...
        public virtual async Task<T> BuildResultFromResponse<T>() where T : new()
        {
