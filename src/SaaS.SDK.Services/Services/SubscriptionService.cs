...
namespace Microsoft.Marketplace.SaaS.SDK.Services.Services
{
    ...
    public class SubscriptionService
    {
        ...
        public int AddOrUpdatePartnerSubscriptions(SubscriptionResult subscriptionDetail, int customerUserId = 0, int subscribeId = 0)
        {
            ...
            Subscriptions newSubscription = new Subscriptions()
            {
                ...
                // PlanGUId = subscriptionDetail.PlanGUId // Requires PR#270
            };
        ...
        public SubscriptionResultExtension PrepareSubscriptionResponse(Subscriptions subscription)
        {
            ...
            SubscriptionResultExtension subscritpionDetail = new SubscriptionResultExtension
            {
                ...
                // PlanGUId = subscription.PlanGUId // Requires PR#270
            };
