...
| **Services client library** | contains the services used by the Customer and Publisher portals to orchestrate calls to the marketplace APIs / database.|SaaS.SDK.Provisioning.Services |
