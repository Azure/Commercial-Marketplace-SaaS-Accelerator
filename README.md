...
- [ASP.NET Core Runtime 5.0](https://dotnet.microsoft.com/download/dotnet-core/5.0)
...
- The SDK has been implemented using [.NET Core 5.0](https://dotnet.microsoft.com/download/dotnet-core/5.0)
